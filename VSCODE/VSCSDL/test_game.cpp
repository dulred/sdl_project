...
void Prensent(SDL_Renderer* renderer){
...
void LogicUpdate(SDL_Window* window){
    ...
    if (playerRect.w + playerRect.x >= WindowCurrentWidth - TriangleHeight || playerRect.h + playerRect.y >= WindowCurrentHeight - TriangleHeight)
    {
        isGameOver = true;
